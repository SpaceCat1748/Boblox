...
end)for i,v in pairs(game:GetService("CoreGui"):GetChildren()) do
    if v.Name == "Discord" then
       v:Destroy()
    end
end
...
game:GetService("RunService").RenderStepped:Connect(function()
    if getgenv().ab == true then
      for i,v in pairs(game:GetService("Players").LocalPlayer.PlayerGui.Main.Menus.Upgrades.Inner.Upgrades.Hold:GetChildren()) do
